...
foreach ($idols as $idol) {
    ...
    $query .= "INSERT INTO Idols (romajiname, japanesename, birthday, height, weight, bloodtype, productioncompany, image) VALUES ('$romajiName', '$japaneseName', '$birthday','$height', '$weight', '$bloodType', '$productionCompany', '$image');";
}
